# Weikhack Beta Version 0.0.5

Weikhack Beta Version 0.0.5 ist ein externer Fabric Client-Mod für Minecraft 1.21.11. Der Mod wird einfach als normale `.jar` in den Minecraft `mods`-Ordner gelegt und kann dadurch zusammen mit anderen Fabric-Mods genutzt werden, zum Beispiel Cinematica oder weiteren Client-Erweiterungen.

## Features

- Modernes Ingame-UI über `Right Shift`
- Movement-Module wie Flight, Speed, NoFall, NoInertia, AutoSprint und JumpHeight
...
- Player-Module wie Chest Stealer und Freecam
...
- Standardmäßig sind alle Module und Zieloptionen ausgeschaltet

## Installation

1. Fabric Loader für Minecraft 1.21.11 installieren.
2. Die aktuelle `weikhack-beta-version-0.0.5.jar` aus den Releases, aus dem Ordner `releases/` oder aus GitHub Actions herunterladen.
